...
#### Load and plot ViT-L/14 results ####
...
# base2="/shared/share_mala/rohan/test_and_open_clip/wise-ft/models/wiseft/ViTL14_10/"
# end1="zeroshot.pt"
# zeroshot_path="$base2$end1"
# base3="/shared/share_mala/rohan/test_and_open_clip/wise-ft/models/wiseft/ViTL14_10/finetuned/"
# end2="checkpoint_7.pt"
# finetuned_path="$base3$end2"
...
# python wise_ft.py   \
#     --train-dataset=ImageNet  \
#     --load=$zeroshot_path,$finetuned_path  \
#     --save=$save  \
#     --epochs=10  \
#     --lr=3e-5  \
#     --data_augmentation=1  \
...
#     --template=openai_imagenet_template  \
#     --eval-datasets=ImageNet,ImageNetV2,ImageNetR,ImageNetSketch \
#     --alpha 0 0.1 0.3 0.5 0.7 0.9 1.0
# wait
